...
@GenerateMocks([NetworkInfo, FirebaseAuth, FirebaseFirestore, User])
  ...
  group('Firebase Providers', () {
    ...
    group('firestoreConnectionProvider', () {
      test('should provide connectivity status', () async {
        // Act
        final connectivityFuture = container.read(
          firestoreConnectionProvider.future,
        );
    ...
    group('collection providers', () {
      ...
      test(
        'gameSessionsCollectionProvider should provide game sessions collection',
        () {
          // Act
          final gameSessionsCollection = container.read(
            gameSessionsCollectionProvider,
          );
      ...
      test(
        'leaderboardsCollectionProvider should provide leaderboards collection',
        () {
          // Act
          final leaderboardsCollection = container.read(
            leaderboardsCollectionProvider,
          );
