...
void main() {
  group('BaseRepository', () {
    ...
    group('handleRepositoryOperation', () {
      ...
      testWidgets(
        'should return failure result when operation throws exception',
        (tester) async {
          // Act
      ...
      testWidgets(
        'should return failure result when operation throws failure',
        (tester) async {
          // Act
    ...
    group('error mapping', () {
      ...
      testWidgets('should preserve failure when operation throws failure', (
        ...
        failure?.when(
          serverFailure: (message, code) =>
              expect(message, equals('test_server_failure')),
          networkFailure: (message) => fail('Should not be network failure'),
          authFailure: (message, code) => fail('Should not be auth failure'),
          firestoreFailure: (message, code) =>
              fail('Should not be firestore failure'),
