...
final optimizedPinLookupProvider =
    FutureProvider.family<String?, String>((ref, pin) async {
...
final currentQuestionStreamProvider =
...
final joinSessionWithPinProvider = FutureProvider.family<bool, JoinSessionParams>((
  ref,
  params,
) async {
  final currentUser = ref.watch(currentUserProvider);
  ...
  final sessionId = await ref.read(optimizedPinLookupProvider(params.pin).future);
  if (sessionId == null) {
