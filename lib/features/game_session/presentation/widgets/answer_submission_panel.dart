...
class AnswerSubmissionPanel extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AnswerSubmissionPanel> createState() => _AnswerSubmissionPanelState();
}
...
class _AnswerSubmissionPanelState extends ConsumerState<AnswerSubmissionPanel> {
  ...
  Widget build(BuildContext context) {
    return widget.question.when(
      multipleChoice: (_, __, options, correctAnswerIndex, ___, ____, _____, ______) {
  ...
  Widget _buildMultipleChoiceGrid(List<String> options, int correctAnswerIndex) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final isCorrect = widget.showCorrectAnswer && index == correctAnswerIndex;
        final isSelected = _selectedIndex == index;
        final isWrong = widget.showCorrectAnswer && isSelected && index != correctAnswerIndex;
        ...
        return MouseRegion(
          ...
          child: AnswerButton(
            ...
            onPressed: widget.isSubmitted ? null : () => _handleAnswerTap(index),
          ...
          .scale(
            begin: _hoveredIndex == index && !widget.isSubmitted ? 1.05 : 1.0,
            end: 1.0,
  ...
  Widget _buildTrueFalseButton({
    ...
    final isSelected = _selectedIndex == index;
    final isWrong = widget.showCorrectAnswer && isSelected && index != correctIndex;
  ...
  Color _getButtonColor(int index, Color defaultColor, bool isCorrect, bool isWrong) {
