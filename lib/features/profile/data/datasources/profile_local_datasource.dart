...
class ProfileSharedPrefsDataSource implements ProfileLocalDataSource {
  ...
  ProfileSharedPrefsDataSource({required SharedPreferences prefs})
    : _prefs = prefs;
  ...
  Future<void> cacheProfile(UserProfileModel profile) async {
    try {
      ...
      AppLogger.info(
        'ProfileLocalDataSource',
        'Profile cached successfully: ${profile.id}',
      );
    } catch (e) {
  ...
  Future<UserProfileModel?> getCachedProfile(String userId) async {
    try {
      ...
      if (profileJson == null) {
        AppLogger.info(
          'ProfileLocalDataSource',
          'No cached profile found: $userId',
        );
        return null;
      }
      ...
      AppLogger.info(
        'ProfileLocalDataSource',
        'Cached profile retrieved: $userId',
      );
      return profile;
    } catch (e) {
  ...
  Future<void> removeCachedProfile(String userId) async {
    try {
      AppLogger.info(
        'ProfileLocalDataSource',
        'Removing cached profile: $userId',
      );
  ...
  Future<void> cacheUserPreferences(
    ...
    try {
      AppLogger.info(
        'ProfileLocalDataSource',
        'Caching user preferences: $userId',
      );
      ...
      AppLogger.info(
        'ProfileLocalDataSource',
        'User preferences cached: $userId',
      );
    } catch (e) {
  ...
  Future<UserPreferencesModel?> getCachedUserPreferences(String userId) async {
    try {
      AppLogger.info(
        'ProfileLocalDataSource',
        'Getting cached user preferences: $userId',
      );
      ...
      if (preferencesJson == null) {
        AppLogger.info(
          'ProfileLocalDataSource',
          'No cached preferences found: $userId',
        );
        return null;
      }
      ...
      AppLogger.info(
        'ProfileLocalDataSource',
        'Cached preferences retrieved: $userId',
      );
      return preferences;
    } catch (e) {
  ...
  Future<UserStatsModel?> getCachedUserStats(String userId) async {
    try {
      AppLogger.info(
        'ProfileLocalDataSource',
        'Getting cached user stats: $userId',
      );
  ...
  Future<void> setLastSyncTimestamp(String userId, DateTime timestamp) async {
    try {
      AppLogger.info(
        'ProfileLocalDataSource',
        'Setting last sync timestamp: $userId',
      );

      await _prefs.setString(
        _syncTimestampKey(userId),
